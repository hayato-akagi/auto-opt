...
SUPPORTED_ALGORITHM = "adaptive-controller"
...
def create_app(
    ...
    app = FastAPI(title="adaptive-controller", version="0.1.0", lifespan=lifespan)
    ...
    async def control_run(payload: ControlRunRequest) -> ControlRunResponse:
        ...
        return await run_control_loop(payload, resolved_client)
